...
<div data-role="page" id="controls" data-theme="a">
	...
	<div data-role="content" class="content">
        ...
        <div class="ui-content">
            <form method="get" action="">
		        <fieldset class="ui-field-contain"> 
                    ...
                    <input type="text" name="max-peers" style="width: 10em !important;" id="max-peers" value="" placeholder="125"/>
			    </fieldset>
			</form>
		</div>
        <div data-role="controlgroup" data-type="horizontal">
            ...
            <input type="button" value="Shutdown" id="bitcoin_shutdown" onClick="myCall(this);" />

		</div>
		<h3><span id="device_status">Device Controls</span></h3>
        <div data-role="controlgroup" data-type="horizontal">
            ...
            <input type="button" value="Restart" id="device_restart" onClick="myCall_dev(this);" />
			<input type="button" value="Shutdown" id="device_shutdown" onClick="myCall_dev(this);" />
